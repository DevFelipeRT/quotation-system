...
/**
 * Immutable Value Object representing MySQL connection credentials.
 *
 * This class encapsulates all required data for connecting to a MySQL database,
 * while applying security best practices through the CredentialsSecurity trait.
 *
 * @immutable
 */
final class MySqlCredentials implements DatabaseCredentialsInterface
{
